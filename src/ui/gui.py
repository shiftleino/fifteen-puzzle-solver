...
class GraphicalUI:
    ...
    def __init__(self):
        self.tile_size = 150
        self.font_size = 80
        self.display_color = (220, 220, 220)
    ...
    def draw_grid(self, display):
        ...
        """
        for i in range(1, 4):
            pygame.draw.line(display, self.line_color, (i * self.tile_size, 0), (i * self.tile_size, 4 * self.tile_size), 10)
            pygame.draw.line(display, self.line_color, (0, i * self.tile_size), (4 * self.tile_size, i * self.tile_size), 10)
    ...
    def draw_tile_values(self, display, tile_values):
        ...
        for i in range(4):
            pos_y = i * self.tile_size
            for j in range(4):
                pos_x = j * self.tile_size
    ...
    def show_solution(self, solution_steps):
        ...
        """
        pygame.init()
        display = pygame.display.set_mode((self.tile_size * 4, self.tile_size * 4))
